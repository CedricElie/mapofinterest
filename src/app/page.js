               ...
               return (
                 <button
                   ...
                   style={{
                     ...
                     color: active ? '#fff' : 'var(--foreground-dark)',
                     border: `1px solid ${active ? c.color : 'var(--surface-border)'}`,
        ...
        <div style={{ padding: '24px', flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          {!pendingLocation ? (
            <button 
              ...
              style={{ 
                width: '100%', padding: '12px', background: isDroppingPin ? '#ef4444' : 'var(--primary)', 
                color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer',
                fontWeight: '600', transition: 'background 0.2s', fontSize: '1rem',
          ...
          {filteredPins.length > 0 && !pendingLocation && (
            <div>
